...
internal interface IntegrityCheckingUniffiLib : Library {
    ...
    fun uniffi_ray_mobile_checksum_method_node_cancel_transfer(): Short
...
internal interface UniffiLib : Library {
    companion object {
        internal val INSTANCE: UniffiLib by lazy {
            ...
            uniffiCallbackInterfaceFileChangeListener.register(lib)
    ...
    fun uniffi_ray_mobile_fn_method_node_cancel_transfer(
        `ptr`: Pointer,
        `id`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Unit
...
private fun uniffiCheckContractApiVersion(lib: IntegrityCheckingUniffiLib) {
    ...
    val scaffolding_contract_version = lib.ffi_ray_mobile_uniffi_contract_version()
...
private fun uniffiCheckApiChecksums(lib: IntegrityCheckingUniffiLib) {
    ...
    if (lib.uniffi_ray_mobile_checksum_method_node_watch_files() != 5725.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_ray_mobile_checksum_constructor_node_new() != 6194.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_ray_mobile_checksum_method_filechangelistener_on_change() != 19137.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
}
...
open class FileWatch :
    ...
    private class UniffiCleanAction(
        ...
        override fun run() {
            pointer?.let { ptr ->
                uniffiRustCall { status ->
                    UniffiLib.INSTANCE.uniffi_ray_mobile_fn_free_filewatch(ptr, status)
                }
            }
        }
    }
...
public interface NodeInterface {
     ...
     */
    fun `watchFiles`(`listener`: FileChangeListener): FileWatch
...
open class Node :
    ...
    private class UniffiCleanAction(
        ...
        override fun run() {
            pointer?.let { ptr ->
                uniffiRustCall { status ->
                    UniffiLib.INSTANCE.uniffi_ray_mobile_fn_free_node(ptr, status)
                }
            }
        }
    }
     ...
     */
    @Throws(RayException::class)
    override fun `cancelTransfer`(`id`: kotlin.ULong) =
        callWithPointer {
            uniffiRustCallWithError(RayException) { _status ->
                UniffiLib.INSTANCE.uniffi_ray_mobile_fn_method_node_cancel_transfer(it, FfiConverterULong.lower(`id`), _status)
            }
        }
...
internal object uniffiCallbackInterfaceFileChangeListener {
    ...
    internal fun register(lib: UniffiLib) {
        lib.uniffi_ray_mobile_fn_init_callback_vtable_filechangelistener(vtable)
    }
}
