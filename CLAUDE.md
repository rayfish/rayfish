...
- **Git:** conventional commit subjects (`feat`/`fix`/`docs`/…) — git-cliff generates the changelog. Never add a Claude / Co-Authored-By attribution. Never commit `docs/`. Never force-push or rewrite history.
