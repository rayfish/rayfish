...
ray firewall suggest <net> --subject H [--allow peer:proto:ports] [--deny peer:proto:ports] [--default deny]  # coordinator-only: suggest rules to a trusted network (rides the signed blob). Token grammar: `proto:ports` (tcp:22, udp:53, tcp:*, any:*) or bare proto (icmp, any, tcp)
